...
# when girls would take a flower and tear its petals, saying 
...
# girls would say at the last petal for a flower of a given number 
# of petals. The number of petals is always greater than 0.

def i_love_u(nb_petals):
    return {
        1:'I love you',
        2:'a little',
        3:'a lot',
...
print(i_love_u(int(input('Enter Number of Petals: '))))