...
# the problem of not enough space left on the bus! He wants you to write a simple program 
...
print(enough(int(input('Enter Cap: ')), int(input('Enter On: ')), int(input('Enter Wait: '))))