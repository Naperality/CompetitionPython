...
# new inhabitants per year come to live in the town. How many years does the town need 
# to see its population greater than or equal to p = 1200 inhabitants?
...
# the body of your function: if the parameter percent is 2 you have to convert it to 0.02.
