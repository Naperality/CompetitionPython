...
# any length ≥ 2 characters. For strings with exactly 2 characters, return an empty string.
...
def remove_last_first(string_):
    return string_[1:-1]
print(remove_last_first(input("Enter String: ")))