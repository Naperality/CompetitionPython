...
# cell containing an X chromosome fertilizes an egg, the resulting zygote will be 
# XX or female. If the sperm cell contains a Y chromosome, then the resulting zygote 
# will be XY or male.
...
# You're going to have a daughter."; If the sperm contains the Y chromosome, 
# return "Congratulations! You're going to have a son.";

def chromosome_check(chromosome):
    return 'Congratulations! You\'re going to have a {}.'.format(['daughter','son'][chromosome.count('Y')])

print(chromosome_check(input('Enter Chromosomes: ')))